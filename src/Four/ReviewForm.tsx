  ...
  return (
    <div className="w-[42rem] space-y-8 rounded-3xl bg-white p-16">
      ...
      <Input
        ...
        placeholder="Example: Easy to use Easy to use Easy to use Easy to use Easy to use Easy to use Easy to use Easy to use Easy to use Easy to use"
        type="textarea"
      />

      <div className="flex gap-x-2">
        <div className="grow">
          <Input title="Nickname" placeholder="Example: Bob007" type="text" />
        </div>
        <div className="grow">
          <Input
      ...
      <button className="rounded-md p-4 text-white bg-[#121633]">Submit product review</button>
    </div>
  );
};
